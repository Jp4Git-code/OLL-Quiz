...
const QUESTIONS = [
  ...
  { cat:"VorgV", topic:"Reihenfolge", q:"Welche Reihenfolge der VorgV ist richtig?", options:["§ 4, § 1, § 2, § 3, § 5, § 6","§ 1, § 2, § 3, § 4, § 5, § 6","§ 6, § 5, § 4, § 3, § 2, § 1","§ 2, § 1, § 4, § 3, § 6, § 5"], correct:1, expl:"Die Normen der VorgV sind in der Reihenfolge §§ 1–6 zu prüfen." },
  ...
  { cat:"VorgV", topic:"§ 2 VorgV", q:"Ein Schießausbilder ordnet Stubenreinigung an. Was ist die typische Falle?", options:["Fachbereich überschreiten","Nachtfrist vergessen","WBO-Frist falsch berechnen","Beschwerdeart falsch wählen"], correct:0, expl:"Der Schießausbilder ist fachlich nur für seinen Fachbereich vorgesetzt, nicht für allgemeine Stubendienste." },
