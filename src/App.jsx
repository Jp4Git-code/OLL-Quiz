...
const QUESTIONS = [
  ...
  { cat:"VorgV", topic:"Vorrangreihenfolge", q:"Welche Vorrangreihenfolge gilt bei konkurrierenden Vorgesetztenverhältnissen nach der VorgV?", options:["§ 1, § 2, § 3, § 4, § 5, § 6","§ 5, § 3, § 1, § 2, § 4; § 6 als ","§ 4, § 2, § 1, § 3, § 5, § 6","§ 6, § 5, § 4, § 3, § 2, § 1"], correct:1, expl:"Für die Prüfung konkurrierender Vorgesetztenverhältnisse gilt die Vorrangreihenfolge § 5 → § 3 → § 1 → § 2 → § 4. § 6  weil er voraussetzt, dass kein anderes Vorgesetztenverhältnis greift." },
